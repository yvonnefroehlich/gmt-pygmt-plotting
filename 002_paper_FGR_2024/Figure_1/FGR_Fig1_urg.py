# #############################################################################
# Fr쉎lich et al. (2024), GJI: Fig. 1
# Map of the Upper Rhine Graben area
# -----------------------------------------------------------------------------
# Fr쉎lich Y., Grund M., Ritter J. R. R. (2024)
...
# Geological units
# -----------------------------------------------------------------------------
# Baden-W체rttemberg: https://maps.lgrb-bw.de
...
dict_color_zeitalter = {
    ...
    "Karbon":                                             "darkorange",
    "Jura":                                               "dodgerblue",
    "Terti채r im Oberrheingraben und Schichtstufenland":   "darkblue",
    "Terti채r im Molassebecken":                           "yellow3",
    "Perm":                                               "red",
    "Perm -Trias":                                        "brown",
    "Trias":                                              "greenyellow",
    "Metamorphe Gesteine":                                "mediumorchid",
    "Pal채ozoische Magmatite":                             "pink",
    "J체ngere Magmatite":                                  "purple4",
    "Impaktgesteine":                                     "tan",
...
# -----------------------------------------------------------------------------
# Select and plot different geological units (only Baden-W체rtemberg)
