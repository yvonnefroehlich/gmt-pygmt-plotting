...
# Focal mechanisem
aki_eq_jp = {
    "strike": 222, "dip": 33, "rake": 103, "magnitude": 7.37, "depth": 34.8,
}
eq_info = "Date " + "2024/04/02 23:58:11 (UTC)" + " | " \
...
eq_catalog_name = f"global_seismicity_{start_date_request}to{end_date_request}" + \
